...
#Get Methods
def Methods(getMain, getShell, getCLI, getCheckFile, getWrite, getRead, getRandom, getThread, getPipe, getSleep, getTime, getProp, getSplit, getJoin, getRev, getTypes, getUpper, getLower, getMath, getLength, getWeb, getJson):
...
def Main():
	...
	if TheName != "" or noSave == True:
		...
		if TheExt in TheName and noSave == False:
			...
			#Get Methods
			ProgMethods = Methods(IsMain, GetShell, IsCLI, GetCheckFile, GetWrite, GetRead, GetRand, GetThreads, GetPipe, GetSleep, GetTime, GetProp, GetSplit, GetJoin, GetRev, GetTypes, GetUpper, GetLower, GetMath, GetLength, GetWeb, GetJson)
			if IsCLI == True:
