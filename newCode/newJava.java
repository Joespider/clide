...
*/
	...
	{
		StringBuilder TheImports = new StringBuilder("");
		...
		if (NeedIOFile)
		{
			TheImports.append("import java.io.File;\n");
		}
		if (NeedScanner)
		{
			TheImports.append("import java.util.Scanner;\n");
		}
		if (NeedInputStreamReader)
		{
			TheImports.append("import java.io.InputStreamReader;\n");
		}
		if (NeedInputStream)
		{
			TheImports.append("import java.io.InputStream;\n");
		}
		if (NeedBufferedInputStream)
		{
			TheImports.append("import java.io.BufferedInputStream;\n");
		}
		if (NeedBufferedWriter)
		{
			TheImports.append("import java.io.BufferedWriter;\n");
		}
		if (NeedBufferedReader)
		{
			TheImports.append("import java.io.BufferedReader;\n");
		}
		if (NeedFileInputStream)
		{
			TheImports.append("import java.io.FileInputStream;\n");
		}
		if (NeedFileWriter)
		{
			TheImports.append("import java.io.FileWriter;\n");
		}
		if (NeedIOException)
		{
			TheImports.append("import java.io.IOException;\n");
		}
		if (NeedDataInputStream)
		{
			TheImports.append("import java.io.DataInputStream;\n");
		}
		if (NeedJavaLangMath)
		{
		...
		if (NeedJavaTime)
		{
			...
			TheImports.append("import java.time.LocalTime;\n");
			TheImports.append("import java.time.LocalDateTime;\n");
			TheImports.append("import java.time.format.DateTimeFormatter;\n");
		}

		//}
		return TheImports.toString();
	}

	private static String GetMethods()
	{
		StringBuilder TheMethods = new StringBuilder("");
		StringBuilder MethodUserIn = new StringBuilder("");
		String MethodPrint = "\t//Print Output\n\tprivate static void print(Object out)\n\t{\n\t\tSystem.out.println(out);\n\t}\n\n";
		StringBuilder MethodLength = new StringBuilder("");
		StringBuilder MethodArrays = new StringBuilder("");
		StringBuilder MethodProp = new StringBuilder("");
		StringBuilder MethodCheckFile = new StringBuilder("");
		StringBuilder MethodReadFile = new StringBuilder("");
		StringBuilder MethodWriteFile = new StringBuilder("");
		StringBuilder MethodShell = new StringBuilder("");
		StringBuilder MethodSplit = new StringBuilder("");
		StringBuilder MethodJoin = new StringBuilder("");
		StringBuilder MethodreplaceAll = new StringBuilder("");
		StringBuilder MethodIsIn = new StringBuilder("");
		StringBuilder MethodRev = new StringBuilder("");
		StringBuilder MethodRand = new StringBuilder("");
		StringBuilder MethodSubStr = new StringBuilder("");
		StringBuilder MethodConv = new StringBuilder("");
		StringBuilder MethodSleep = new StringBuilder("");
		StringBuilder MethodUpper = new StringBuilder("");
		StringBuilder MethodLower = new StringBuilder("");
		StringBuilder MethodGetTypes = new StringBuilder("");
		StringBuilder MethodFS = new StringBuilder("");
		StringBuilder MethodMath = new StringBuilder("");
		StringBuilder MethodDateAndTime = new StringBuilder("");

		//raw_input
		if (getUserIn == true)
		{
			MethodUserIn.append("\t//Get User input\n\tprivate static String raw_input(String Message)\n\t{\n\t\tString input = \"\";\n\t\t//User input from terminal\n\t\tScanner UserIn = new Scanner(System.in);\n\t\tSystem.out.print(Message);\n\t\tinput = UserIn.nextLine();\n\t\treturn input;\n\t}\n\n");
		}
		if (getArrays == true)
		{
			MethodArrays.append("\t//Append content to array\n\tprivate static char[] Append(char[] ArrayName, char content)\n\t{\n\t\tint i = ArrayName.length;\n\t\t//growing temp array\n\t\tchar[] temp = new char[i];\n\t\t//copying ArrayName array into temp array.\n\t\tSystem.arraycopy(ArrayName, 0, temp, 0, i);\n\t\t//creating a new array\n\t\tArrayName = new char[i+1];\n\t\t//copying temp array into ArrayName\n\t\tSystem.arraycopy(temp, 0, ArrayName, 0, i);\n\t\t//storing user input in the arrayn\n\t\tArrayName[i] = content;\n\t\treturn ArrayName;\n\t}\n\n");
		...
		if (getSleep == true)
		{
			MethodSleep.append("\tprivate static void sleep(long millies)\n\t{\n\t\ttry\n\t\t{\n\t\t\tThread.sleep(millies);\n\t\t}\n\t\tcatch (InterruptedException e)\n\t\t{\n\t\t\tThread.currentThread().interrupt();\n\t\t}\n\t}\n\n");
		}
		if (getSplit == true)
		{
			...
			MethodSplit.append("\tprivate static String BeforeSplit(String Str, String splitAt)\n\t{\n\t\tif (Str.contains(splitAt))\n\t\t{\n\t\t\tString[] newString = split(Str, splitAt, 0);\n\t\t\treturn newString[0];\n\t\t}\n\t\telse\n\t\t{\n\t\t\treturn \"\";\n\t\t}\n\t}\n\n");
			MethodSplit.append("\tprivate static String AfterSplit(String Str, String splitAt)\n\t{\n\t\tif (Str.contains(splitAt))\n\t\t{\n\t\t\tStringBuilder SplitContent = new StringBuilder(\"\");\n\t\t\tString[] newString = split(Str, splitAt, 0);\n\t\t\tfor (int lp = 1; lp != len(newString); lp++)\n\t\t\t{\n\t\t\t\tif (lp != 1)\n\t\t\t\t{\n\t\t\t\t\tSplitContent.append(splitAt);\n\t\t\t\t}\n\t\t\t\tSplitContent.append(newString[lp]);\n\t\t\t}\n\t\t\treturn SplitContent.toString();\n\t\t}\n\t\telse\n\t\t{\n\t\t\treturn \"\";\n\t\t}\n\t}\n\n");
		}
		if (getConvert == true)
		{
			MethodConv.append("\tprivate static double Dbl(int number)\n\t{\n\t\tdouble MyDouble = Double.valueOf(number);\n\t\treturn MyDouble;\n\t}\n\n");
			MethodConv.append("\tprivate static double Dbl(String number)\n\t{\n\t\tdouble MyDouble = 0.0;\n\t\ttry\n\t\t{\n\t\t\tMyDouble = Double.parseDouble(number);\n\t\t}\n\t\tcatch (NumberFormatException ex)\n\t\t{\n\t\t\tex.printStackTrace();\n\t\t}\n\t\treturn MyDouble;\n\t}\n\n");
			MethodConv.append("\tprivate static int Int(double number)\n\t{\n\t\tint MyInt = (int)number;\n\t\treturn MyInt;\n\t}\n\n");
			MethodConv.append("\tprivate static int Int(String number)\n\t{\n\t\tint MyInt = 0;\n\t\ttry\n\t\t{\n\t\t\tMyInt = Integer.parseInt(number);\n\t\t}\n\t\tcatch (NumberFormatException ex)\n\t\t{\n\t\t\tex.printStackTrace();\n\t\t}\n\t\treturn MyInt;\n\t}\n\n");
			MethodConv.append("\tprivate static String Str(Object Item)\n\t{\n\t\tString MyString = String.valueOf(Item);\n\t\treturn MyString;\n\t}\n\n");
		}
		if (getSubStr == true)
		{
		...
		if (getIsIn == true)
		{
			MethodIsIn.append("\tprivate static boolean IsIn(String Str, String Sub)\n\t{\n\t\tboolean found = false;\n\t\tif (Str.contains(Sub))\n\t\t{\n\t\t\tfound = true;\n\t\t}\n\t\treturn found;\n\t}\n\n");
			MethodIsIn.append("\t//Check if string begins with substring\n\tprivate static boolean StartsWith(String Str, String Start)\n\t{\n\t\tboolean ItDoes = Str.startsWith(Start);\n\t\treturn ItDoes;\n\t}\n\n");
			MethodIsIn.append("\t//Check if string ends with substring\n\tprivate static boolean EndsWith(String Str, String Start)\n\t{\n\t\tboolean ItDoes = Str.endsWith(Start);\n\t\treturn ItDoes;\n\t}\n\n");
		}
		if (getJoin == true)
		{
			MethodJoin.append("\tprivate static String join(String[] Str, String ToJoin)\n\t{\n\t\tString message = String.join(ToJoin, Str);\n\t\treturn message;\n\t}\n\n");
		}
		if ((getSplit == true) && (getJoin == true))
		{
			MethodreplaceAll.append("\tprivate static String replaceAll(String message, String sBy, String jBy)\n\t{\n\t\tString NewMessage = message.replaceAll(sBy,jBy);\n\t\treturn NewMessage;\n\t}\n\n");
			MethodreplaceAll.append("\tprivate static String replaceFirst(String message, String sBy, String jBy)\n\t{\n\t\tString NewMessage = message.replaceFirst(sBy,jBy);\n\t\treturn NewMessage;\n\t}\n\n");
			MethodreplaceAll.append("\tprivate static String replaceLast(String message, String sBy, String jBy)\n\t{\n\t\tString NewMessage = message;\n\t\tint lastIndex = message.lastIndexOf(sBy);\n\t\tif (lastIndex != -1)\n\t\t{\n\t\t\tString beginString = message.substring(0, lastIndex);\n\t\t\tString endString = message.substring(lastIndex + sBy.length());\n\t\t\tNewMessage = beginString + jBy + endString;\n\t\t}\n\t\treturn NewMessage;\n\t}\n\n");
		}
		if (getRandom == true)
		{
			MethodRand.append("\tprivate static int random(int min, int max)\n\t{\n\t\treturn (int)(Math.random() * (max - min) + min);\n\t}\n\n");
			MethodRand.append("\tprivate static int random(int max)\n\t{\n\t\treturn (int)(Math.random() * max);\n\t}\n\n");
		}
		if (getUpper == true)
		{

			MethodUpper.append("\tprivate static String toUpperCase(String TheStr)\n\t{\n\t\tTheStr = TheStr.toUpperCase();\n\t\treturn TheStr;\n\t}\n\n");
			MethodUpper.append("\tprivate static String toUpperCase(String TheStr, int plc)\n\t{\n\t\tString newStr = TheStr;\n\t\tint end = TheStr.length();\n\t\tchar[] Upper = TheStr.toCharArray();\n\t\tif ((plc < end) && (end != 0) && (plc >= 0))\n\t\t{\n\t\t\tUpper[plc] = Character.toUpperCase(Upper[plc]);\n\t\t\tnewStr = String.valueOf(Upper);\n\t\t}\n\t\treturn newStr;\n\t}\n\n");
		}
		if (getLower == true)
		{
			MethodLower.append("\tprivate static String toLowerCase(String TheStr)\n\t{\n\t\tTheStr = TheStr.toLowerCase();\n\t\treturn TheStr;\n\t}\n\n");
			MethodLower.append("\tprivate static String toLowerCase(String TheStr, int plc)\n\t{\n\t\tString newStr = TheStr;\n\t\tint end = TheStr.length();\n\t\tchar[] Lower = TheStr.toCharArray();\n\t\tif ((plc < end) && (end != 0) && (plc >= 0))\n\t\t{\n\t\t\tLower[plc] = Character.toLowerCase(Lower[plc]);\n\t\t\tnewStr = String.valueOf(Lower);\n\t\t}\n\t\treturn newStr;\n\t}\n\n");
		}

		if (getTypes == true)
		{
			MethodGetTypes.append("\tprivate static String Type(Object Data)\n\t{\n\t\tString TheType = \"\";\n\t\tif (Data instanceof Integer)\n\t\t{\n\t\t\tTheType = \"int\";\n\t\t}\n\t\telse if (Data instanceof Double)\n\t\t{\n\t\t\tTheType = \"double\";\n\t\t}\n\t\telse if (Data instanceof String)\n\t\t{\n\t\t\tTheType = \"String\";\n\t\t}\n\t\telse if (Data instanceof Object[])\n\t\t{\n\t\t\tTheType = \"Array\";\n\t\t}\n\t\telse\n\t\t{\n\t\t\tTheType = \"unknown\";\n\t\t}\n\t\treturn TheType;\n\t}\n\n");
		}
		...
		if (getMath == true)
		{
			MethodMath.append("\tprivate static double max(double a, double b)\n\t{\n\t\treturn Math.max(a,b);\n\t}\n\n");
			MethodMath.append("\tprivate static float max(float a, float b)\n\t{\n\t\treturn Math.max(a,b);\n\t}\n\n");
			MethodMath.append("\tprivate static long max(long a, long b)\n\t{\n\t\treturn Math.max(a,b);\n\t}\n\n");
			MethodMath.append("\tprivate static int max(int a, int b)\n\t{\n\t\treturn Math.max(a,b);\n\t}\n\n");
			MethodMath.append("\tprivate static double min(double a, double b)\n\t{\n\t\treturn Math.min(a,b);\n\t}\n\n");
			MethodMath.append("\tprivate static float min(float a, float b)\n\t{\n\t\treturn Math.min(a,b);\n\t}\n\n");
			MethodMath.append("\tprivate static long min(long a, long b)\n\t{\n\t\treturn Math.min(a,b);\n\t}\n\n");
			MethodMath.append("\tprivate static int min(int a, int b)\n\t{\n\t\treturn Math.min(a,b);\n\t}\n\n");
			MethodMath.append("\tprivate static double abs(double a)\n\t{\n\t\treturn Math.abs(a);\n\t}\n\n");
			MethodMath.append("\tprivate static float abs(float a)\n\t{\n\t\treturn Math.abs(a);\n\t}\n\n");
			MethodMath.append("\tprivate static int abs(int a)\n\t{\n\t\treturn Math.abs(a);\n\t}\n\n");
			MethodMath.append("\tprivate static long abs(long a)\n\t{\n\t\treturn Math.abs(a);\n\t}\n\n");
			MethodMath.append("\tprivate static double acos(double a)\n\t{\n\t\treturn Math.acos(a);\n\t}\n\n");
			MethodMath.append("\tprivate static double asin(double a)\n\t{\n\t\treturn Math.asin(a);\n\t}\n\n");
			MethodMath.append("\tprivate static double atan(double a)\n\t{\n\t\treturn Math.atan(a);\n\t}\n\n");
			MethodMath.append("\tprivate static double cbrt(double a)\n\t{\n\t\treturn Math.cbrt(a);\n\t}\n\n");
			MethodMath.append("\tprivate static double ceil(double a)\n\t{\n\t\treturn Math.ceil(a);\n\t}\n\n");
			MethodMath.append("\tprivate static double cos(double a)\n\t{\n\t\treturn Math.cos(a);\n\t}\n\n");
			MethodMath.append("\tprivate static double cosh(double x)\n\t{\n\t\treturn Math.cosh(x);\n\t}\n\n");
			MethodMath.append("\tprivate static double exp(double a)\n\t{\n\t\treturn Math.exp(a);\n\t}\n\n");
			MethodMath.append("\tprivate static double expm1(double x)\n\t{\n\t\treturn Math.expm1(x);\n\t}\n\n");
			MethodMath.append("\tprivate static double floor(double a)\n\t{\n\t\treturn Math.floor(a);\n\t}\n\n");
			MethodMath.append("\tprivate static int fmod(int x, int y)\n\t{\n\t\treturn Math.floorMod(x, y);\n\t}\n\n");
			MethodMath.append("\tprivate static long fmod(long x, long y)\n\t{\n\t\treturn Math.floorMod(x, y);\n\t}\n\n");
			MethodMath.append("\tprivate static double hypot(double x, double y)\n\t{\n\t\treturn Math.hypot(x, y);\n\t}\n\n");
			MethodMath.append("\tprivate static double pow(double a, double b)\n\t{\n\t\treturn Math.pow(a, b);\n\t}\n\n");
			MethodMath.append("\tprivate static double sin(double a)\n\t{\n\t\treturn Math.sin(a);\n\t}\n\n");
			MethodMath.append("\tprivate static double sinh(double x)\n\t{\n\t\treturn Math.sinh(x);\n\t}\n\n");
			MethodMath.append("\tprivate static double tan(double a)\n\t{\n\t\treturn Math.tan(a);\n\t}\n\n");
			MethodMath.append("\tprivate static double tanh(double x)\n\t{\n\t\treturn Math.tanh(x);\n\t}\n\n");
			MethodMath.append("\tprivate static double sqrt(double Number)\n\t{\n\t\treturn Math.sqrt(Number);\n\t}\n\n");
			MethodMath.append("\tprivate static int round(float Number)\n\t{\n\t\treturn Math.round(Number);\n\t}\n\n");
			MethodMath.append("\tprivate static long round(double Number)\n\t{\n\t\treturn Math.round(Number);\n\t}\n\n");
			MethodMath.append("\tprivate static double log(double Number)\n\t{\n\t\treturn Math.log(Number);\n\t}\n\n");
		}
		if (getDateAndTime == true)
		{
			MethodDateAndTime.append("\tprivate static String getTime()\n\t{\n\t\tLocalTime time = LocalTime.now();\n\t\tDateTimeFormatter JustTime = DateTimeFormatter.ofPattern(\"HH:mm:ss\");\n\t\tString theTime = JustTime.format(time);\n\t\treturn theTime;\n\t}\n\n");
			MethodDateAndTime.append("\tprivate static String TimeAndDate()\n\t{\n\t\tLocalDateTime dt = LocalDateTime.now();\n\t\tDateTimeFormatter dtf = DateTimeFormatter.ofPattern(\"E MMM dd HH:mm:ss yyyy\");\n\t\tString formatted = dtf.format(dt);\n\t\treturn formatted;\n\t}\n\n");
		}
		TheMethods.append(MethodProp.toString());
		TheMethods.append(MethodUserIn.toString());
		TheMethods.append(MethodPrint);
		TheMethods.append(MethodLength.toString());
		TheMethods.append(MethodArrays.toString());
		TheMethods.append(MethodCheckFile.toString());
		TheMethods.append(MethodReadFile.toString());
		TheMethods.append(MethodWriteFile.toString());
		TheMethods.append(MethodShell.toString());
		TheMethods.append(MethodSleep.toString());
		TheMethods.append(MethodIsIn.toString());
		TheMethods.append(MethodRev.toString());
		TheMethods.append(MethodSplit.toString());
		TheMethods.append(MethodJoin.toString());
		TheMethods.append(MethodreplaceAll.toString());
		TheMethods.append(MethodConv.toString());
		TheMethods.append(MethodSubStr.toString());
		TheMethods.append(MethodRand.toString());
		TheMethods.append(MethodUpper.toString());
		TheMethods.append(MethodLower.toString());
		TheMethods.append(MethodGetTypes.toString());
		TheMethods.append(MethodFS.toString());
		TheMethods.append(MethodMath.toString());
		TheMethods.append(MethodDateAndTime.toString());
